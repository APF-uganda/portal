...
export const managementMembers: ManagementMember[] = [
  {
    ...
    role: 'Treasurer',
    photo: '/images/aboutPage-images/leader5.webp',
    summary: 'CPA Silver Boss Mwebesa serves as Treasurer, overseeing APF financial stewardship, planning discipline, and prudent resource allocation. He supports transparent reporting and sustainable financing for member-focused programs. Outside APF, he is engaged in financial management and advisory work that helps organizations strengthen controls and performance.',
    whoTheyAre: 'A finance-focused CPA with strong expertise in stewardship, controls, and fiscal planning.',
    outsideApf: 'Works in financial management and advisory roles across private and institutional settings.',
  },
  {
    id: 7,
  ...
  },
  {
    ...
    photo: '/images/aboutPage-images/leader2.webp',
    summary: 'CPA Ronald Mutumba serves as Implementing Director and Board Member, leading execution of APF priorities and day-to-day delivery of strategic programs. He supports institutional coordination, member engagement, and operational excellence. Outside APF, he works across professional practice and business advisory assignments that strengthen organizations and reporting quality.',
    whoTheyAre: 'A results-oriented accounting professional with strong execution and stakeholder coordination skills.',
    outsideApf: 'Involved in advisory and practice operations supporting compliance and business improvement.',
  },
];
