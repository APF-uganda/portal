...
export const chairpersonMessage = {
  ...
  role: 'Board Chairperson - APF Uganda',
  photo: chairmanImg,
  fullMessage: `Dear Colleagues and Partners,

It is a privilege to lead the Accountancy Practitioners Forum (APF) at such a transformative time for our profession. Our vision is to be the premier catalyst for accountancy excellence in Uganda. We aspire to build a future where every licensed practice regardless of size is a beacon of integrity, innovation, and global professional trust.
