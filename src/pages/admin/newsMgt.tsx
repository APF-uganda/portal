                          ...
                          <tr key={article.id} className="hover:bg-slate-50/50 transition-all group">
                            <td className="px-10 py-7">
                              <div className="flex items-center gap-6">
                                <div className="w-20 h-12 md:w-28 md:h-16 rounded-[1.5rem] bg-slate-100 overflow-hidden border border-slate-100 flex-shrink-0 shadow-sm">
                                  {article.featuredImage ? (
                                    <img src={article.featuredImage} className="w-full h-full object-cover grayscale-[0.2] group-hover:grayscale-0 transition-all duration-700 group-hover:scale-110" alt=""/>
                                  ) : (
                                    <div className="w-full h-full flex items-center justify-center bg-slate-50 text-slate-200"><ImageIcon size={24}/></div>
                                  )}
                                </div>
                            ...
                            <td className="px-6 py-7 text-center">
                              {article.isFeatured ? (
                                ...
                                <span className="text-gray-300 font-bold text-[10px] uppercase tracking-widest italic opacity-50">Standard</span>
                              )}
                            </td>
