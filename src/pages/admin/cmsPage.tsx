    ...
    <div className="flex items-center gap-4">
      ...
      <div>
        ...
        {loading ? (
          ...
          <h4 className="text-2xl text-slate-900 font-semibold">{value}</h4>
        )}
      </div>
    </div>
          ...
          <div className="max-w-6xl mx-auto space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <button 
                ...
                className="flex items-center justify-between p-8 bg-white border border-gray-100 rounded-3xl hover:border-purple-300 hover:shadow-lg transition-all text-left group h-full"
              >
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-slate-900">Create News</h3>
                    <p className="text-xs text-slate-400 mt-1 uppercase font-bold tracking-widest">Publish articles</p>
                  </div>
                </div>
              ...
              <button 
                onClick={() => navigate('/admin/eventsreg')}
                className="flex items-center justify-between p-8 bg-white border border-gray-100 rounded-3xl hover:border-blue-300 hover:shadow-lg transition-all text-left group h-full"
              >
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mt-1 uppercase font-bold tracking-widest">Verify attendees</p>
                  </div>
                </div>
                    ...
                    <div key={i} className="flex items-center justify-between border-b border-gray-50 pb-4 last:border-0 last:pb-0 group">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="min-w-0">
                          <p className="text-sm font-semibold text-slate-900 truncate group-hover:text-purple-600 transition-colors cursor-pointer">{activity.title}</p>
                          <p className="text-[10px] text-gray-400 font-bold uppercase">{activity.type} • {activity.time}</p>
                        </div>
                      </div>
                      <Eye size={16} className="text-gray-300 cursor-pointer hover:text-purple-600 transition-colors" />
                    </div>
                  )) : (
