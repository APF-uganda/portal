...
function Hero() {
  return (
    <section 
      className="h-[700px] flex items-center justify-center relative overflow-hidden pt-16 -mt-16 bg-cover bg-center"
      style={{
    ...
    >
      ...
      <div className="max-w-3xl mx-auto text-center text-white p-8 relative z-10 animate-fade-in-up">
        <h2 className="text-[2rem] md:text-[3rem] mb-6 font-bold animate-fade-in-up [animation-delay:0.2s] [animation-fill-mode:both]">
          Advancing Accountancy<br />Excellence in Uganda
        </h2>
        <p className="text-base md:text-[1.1rem] mb-8 leading-relaxed animate-fade-in-up [animation-delay:0.4s] [animation-fill-mode:both]">
