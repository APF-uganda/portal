  ...
  return (
    <div className="bg-white rounded-lg overflow-hidden shadow-[0_2px_8px_rgba(0,0,0,0.1)] transition-all duration-300 ease-in-out animate-fade-in-up h-full flex flex-col hover:-translate-y-2.5 hover:shadow-[0_8px_25px_rgba(124,58,237,0.2)] group">
      ...
      <div className="p-6 flex flex-col flex-grow">
        <h6 className="text-secondary text-[1.1rem] mb-2 min-h-[2.6em] leading-[1.3] line-clamp-2 font-semibold">
          {title}
        </h6>
        ...
        <p className="text-[#666] text-[0.9rem] py-1 pb-4 min-h-[3em] line-clamp-2 flex-grow">
          {description}
        </p>
        <button
          onClick={onRegister}
          className="w-full bg-primary text-white rounded-[25px] py-3 font-semibold transition-all duration-300 ease-in-out mt-auto hover:bg-primary-dark hover:-translate-y-0.5 hover:shadow-[0_4px_12px_rgba(124,58,237,0.4)]"
        >
          Register
        </button>
      </div>
