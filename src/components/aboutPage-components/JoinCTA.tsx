  ...
  return (
    <section className="py-16 px-4 bg-[#F3F4F6]">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <button className="bg-[#6A1B9A] hover:bg-[purple-800] text-white px-10 py-4 text-base font-semibold rounded-[25px] shadow-[0_4px_6px_rgba(124,58,237,0.3)] transition-all duration-300 hover:bg-primary-dark hover:-translate-y-0.5 hover:shadow-[0_6px_12px_rgba(124,58,237,0.4)]">
