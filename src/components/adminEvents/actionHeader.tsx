  ...
  <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-8 font-sans">
    ...
    <div className="flex items-center gap-4">
      ...
      <button 
        ...
        disabled={loading}
        onClick={onPublish} 
        className="px-8 py-2.5 bg-[#5C32A3] text-white rounded-2xl font-black text-sm shadow-xl shadow-purple-200 hover:scale-105 active:scale-95 transition flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {loading ? (
          <>
