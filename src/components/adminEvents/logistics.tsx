...
export const LogisticsSidebar = ({ data, onChange }: any) => {
  ...
  const labelStyles = "text-[10px] text-slate-400 uppercase tracking-[0.2em] ml-1 flex items-center gap-1.5";

  return (
    <div className="bg-slate-950 p-6 md:p-8 rounded-[40px] border border-slate-800 shadow-2xl space-y-8 font-sans">
      <div className="flex items-center justify-between border-b border-slate-800 pb-4">
        <h3 className=" text-white flex items-center gap-3 text-base uppercase tracking-widest">
      ...
      <div className="space-y-6">
        ...
        {/* END SCHEDULE (OPTIONAL BY BEHAVIOR) */}
