  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
        <div>
           <h2 className="text-xl  text-slate-800 uppercase tracking-tight">Editing: {pageId}</h2>
           <p className="text-xs text-slate-400 font-bold">Live updates for the public website</p>
        </div>
        <button className="bg-[#5C32A3] text-white px-8 py-2 rounded-xl  shadow-lg shadow-purple-100 hover:scale-105 transition">
          PUBLISH CHANGES
        </button>
      </div>
